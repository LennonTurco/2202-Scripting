function Point(x, y) {
    ...
    this.midpoint = function(p2){
        ...
        const my = (this.y + p2.y) /2; // note there was a typo in the readme file, so I used the corrected def. of midpoint instead in this line
    ...
    this.scaleTo = function(p2,s){
        ...
        const sx = this.x + (p2.x - this.x) *s;
        const sy = this.y + (p2.y - this.y) *s;
