let getDictionary = function (lang)
{
    ...
    let englishDictionary = function (number)
    {
        ...
        */      
        switch(number) {
            ...
            case 2: return "two";
            case 3: return "three";
            default: return undefined; // note to self that return undefined is optional here as all the inputs will have cases, but good practice to include it.
        }
    }
    ...
    */
    ...
    if (lang === 'E') {
        ...
        return undefined; // in case the lang argument is neither 'E' nor 'F', not specified in the instructions but good practice again.
    }
